...
export default function BackofficeIndex() {
  ...
  const availablePermissions = [
    { id: 'dashboard:access', name: 'Acessar Dashboard' },
    ...
    { id: 'timesheet:read', name: 'Visualizar Controle de Ponto' },    
    { id: 'payroll:read', name: 'Visualizar Folha de Pagamento' },   
    { id: 'payslip:read', name: 'Visualizar Holerites' },    
    { id: 'benefit:read', name: 'Visualizar Beneficios' },  
